...
import {CounsumerBaseV2} from "@chainlink/contracts/src/v0.8/VRFConsumerBaseV2.sol";
...
contract RandomIpfsNFT is VRFConsumerBaseV2, ERC721URIStorage, Ownable{
    ...
    constructor(string[3] memory _dogUris, address _vrfCoord, bytes _gasLane, uint64 _subId, uint32 _callback, uint _interval) VRFConsumerBaseV2(_vrfCoord) ERC721("RandoIpfsDemo", "RID"){
    ...
    function fulfillRandomWords(uint requestId, uint[] memory randomWords) internal override {
        address dogOwner = itToSender[requestId];
